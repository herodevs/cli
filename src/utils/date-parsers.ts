...
export const parseDate = (input: string) =>
  parse(input, DEFAULT_DATE_FORMAT, new Date());

export const formatDate = (input: Date) => format(input, DEFAULT_DATE_FORMAT);

export const formatISODate = (input: Date) => formatISO(input);

export const formatCommitDate = (input: Date) =>
  format(input, DEFAULT_DATE_COMMIT_FORMAT);

export const formatCommitDateMonth = (input: Date) =>
  format(input, DEFAULT_DATE_COMMIT_MONTH_FORMAT);

export const subtractMonths = (input: Date, months: number) =>
  subMonths(input, months);
