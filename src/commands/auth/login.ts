        ...
        if (parsedUrl.pathname === '/oauth2/callback') {
          ...
          if (oauthError) {
            ...
            const browserMessage = isAlreadyLoggedIn
              ...
              : isDifferentUserAuthenticated
                ? "You're signed in with a different account than this sign-in attempt. Return to the terminal."
                : "We couldn't complete sign-in. Return to the terminal and try again.";
            const cliErrorMessage = isAlreadyLoggedIn
              ? `You're already signed in. Run "hd auth login" again to continue.`
              : isDifferentUserAuthenticated
                ...
                : `We couldn't complete sign-in. Please run "hd auth login" again.`;
