...
```sh
curl -o- https://raw.githubusercontent.com/herodevs/cli/v2.0.0-beta.17/scripts/install.sh | bash
```

```sh
wget -qO- https://raw.githubusercontent.com/herodevs/cli/v2.0.0-beta.17/scripts/install.sh | bash
```
